...
export default function ProjectSectionOne() {
    return (
        <section className="project pt-130 pb-130">
            <div className="project__wrp">
                ...
                <div className="container">
                    <div className="row justify-content-end">
                        <div className="col-lg-6 ps-4 bor-left py-lg-5">
                            <div className="section-header pr-20">
                                <h5 className="wow fadeInUp" data-wow-duration="1.2s" data-wow-delay=".2s">OUR case
                                    study</h5>
                                <h2 className="wow fadeInUp" data-wow-duration="1.4s" data-wow-delay=".4s">Embracing
                                    Sustainable Travel</h2>
                                    ...
                                    <div className="swiper project-slider2">
                                        ...
                                        >
                                            {projectOneInfos.map((project) => (
                                                <SwiperSlide key={`pro-${project.id}`}>
                            ...
                            <div className="col-lg-6">
                                <div className="swiper project-slider mt-5 d-block d-lg-none">
                                    ...
                                    >
                                        {projectImages.map((image, index) => (
                                            <SwiperSlide key={`img2-${index}`} className="swiper-slide">
                                                <div className="image">
