import involve1 from "@/assets/images/involve/involve1.png";
import involveSm from "@/assets/images/involve/involve-sm.jpg";
...
export default function InvolveSectionTwo() {
    return (
        <section className="involve-two pb-130">
            <div className="container">
                <div className="row g-4 align-items-center">
                    <div className="col-xl-6">
                        <div className="involve-two__image">
                            <Image src={involve1} alt="image" className="h-auto"/>
                            <div className="image-sm">
                                <Image src={involveSm} alt="image" className="h-auto"/>
                            </div>
                        </div>
                    </div>
                    <div className="col-xl-6">
                        <div className="about-two__right-item">
                            <div className="section-header mb-4">
                                <h5 className="wow fadeInUp" data-wow-duration="1.2s" data-wow-delay=".2s">protecting
                                    nature</h5>
                                <h2 className="wow fadeInUp" data-wow-duration="1.4s" data-wow-delay=".4s">Find
                                    Affordable Dream Cars for Rental</h2>
                            ...
                            <div className="row g-3">
                                <div className="col-md-5 wow fadeInUp" data-wow-duration="1.8s" data-wow-delay=".8s">
                            ...
                            <div className="about_info d-flex align-items-center pt-60 wow fadeInUp"
                                ...
                                <a href="/about" className="btn-one"><span>Join With Us</span> <i
