...
import achievementBg from "@/assets/images/bg/achievement2.jpg";
import achieve1 from "@/assets/images/icon/achieve1.png";
import achieve2 from "@/assets/images/icon/achieve2.png";
import achieve3 from "@/assets/images/icon/achieve3.png";
import {useEffect, useRef, useState} from "react";
import CountUp from "react-countup";
import Image from "next/image";

export default function AchievementSectionTwo() {
    ...
    return (
        <div ref={counterRef} className="achievement-two mt-130">
            <div className="container">
                <div className="achievement p-5" style={{ backgroundImage: `url(${achievementBg.src})`}}>
                    <div className="row g-4 align-items-center justify-content-between">
                        <div className="col-lg-5 achievement__bor-right wow fadeInUp" data-wow-duration="1.2s"
                            ...
                            <div className="achievement__item">
                                <h2 className="text-white pt-3 pb-3">Your Safety is Our Top Priority.</h2>
                            </div>
                        </div>
                        <div className="col-lg-2 achievement__bor-right wow fadeInUp" data-wow-duration="1.4s"
                            ...
                            <div className="achievement__item text-center">
                                <Image src={achieve1} alt="icon" className="h-auto"/>
                                <h5>Kms Driven</h5>
                        ...
                        <div className="col-lg-2 achievement__bor-right wow fadeInUp" data-wow-duration="1.6s"
                             data-wow-delay=".6s">
                            <div className="achievement__item text-center">
                                <Image src={achieve2} alt="icon" className="h-auto"/>
                        ...
                        <div className="col-lg-2 wow fadeInUp" data-wow-duration="1.8s" data-wow-delay=".8s">
                            <div className="achievement__item text-center">
                                <Image src={achieve3} alt="icon" className="h-auto"/>
                                <h5>Cars Restored</h5>
                                <span className="count">
